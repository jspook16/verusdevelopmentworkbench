...
-----------------------------------`;
  ...
  const handleIdentityHistory = async (e) => {
    ...
    try {
      ...
      if (ihTxProofs) params.push(true);
      ...
      setIhError(err.message || 'Failed to get identity history');
    }
  ...
  return (
    <Box sx={{ height: '100vh', width: '100vw', display: 'flex', flexDirection: 'column', background: '#181818', overflowX: 'hidden', overflowY: 'hidden' }}>
      ...
      <Box sx={{ flex: 1, display: 'flex', minHeight: 0, overflow: 'hidden' }}>
              ...
              <Box sx={{ flex: 1, overflowY: 'auto', background: '#232323', borderRadius: 0, ml: 2, mt: 0, p: 2, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
                ...
                {selectedSubOperation ? (
                  <Paper sx={{ p: 2, flex: 0, background: '#181818' }}>
                    ...
                    {/* Identity History Form */}
                    {selectedSubOperation === 'identityhistory' && (
                      <Box component="form" onSubmit={handleIdentityHistory} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                        <Typography sx={{ fontSize: '14px', color: '#fff', mb: 0 }}>
                          Retrieve the history of an identity
                        </Typography>
                        <Typography sx={{ fontSize: '12px', color: '#bbb', fontStyle: 'italic', mb: 1 }}>
                          Get the complete history of an identity, showing all changes over time.
                        </Typography>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                          ...
                          <input
                            type="text"
                            value={ihIdentityNameOrId}
                            onChange={(e) => setIhIdentityNameOrId(e.target.value)}
                            placeholder="Enter identity name (followed by @) or ID"
                            style={{ fontSize: '14px', padding: '8px', borderRadius: '4px', border: '1px solid #444', background: '#232323', color: '#fff' }}
                            required
                          />
                        </Box>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                          ...
                          <input
                            type="number"
                            value={ihHeightStart}
                            onChange={(e) => setIhHeightStart(e.target.value)}
                            placeholder="Enter start block height"
                            style={{ fontSize: '14px', padding: '8px', borderRadius: '4px', border: '1px solid #444', background: '#232323', color: '#fff' }}
                          />
                        </Box>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                          ...
                          <input
                            type="number"
                            value={ihHeightEnd}
                            onChange={(e) => setIhHeightEnd(e.target.value)}
                            placeholder="Enter end block height"
                            style={{ fontSize: '14px', padding: '8px', borderRadius: '4px', border: '1px solid #444', background: '#232323', color: '#fff' }}
                          />
                        </Box>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'row', gap: 2, alignItems: 'center' }}>
                          ...
                          <Switch
                            checked={ihTxProofs}
                            onChange={(e) => setIhTxProofs(e.target.checked)}
                            color="primary"
                          />
                        </Box>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                          ...
                          <input
                            type="number"
                            value={ihTxProofHeight}
                            onChange={(e) => setIhTxProofHeight(e.target.value)}
                            placeholder="Enter tx proof height"
                            style={{ fontSize: '14px', padding: '8px', borderRadius: '4px', border: '1px solid #444', background: '#232323', color: '#fff' }}
                          />
                        </Box>
                        
                        {ihError && <Alert severity="error" sx={{ mt: 1 }}>{ihError}</Alert>}
                        ...
                        <Box sx={{ display: 'flex', gap: 2, mt: 1 }}>
                          <Button 
                            ...
                            variant="contained" 
                            color="primary" 
                            disabled={ihLoading || !ihIdentityNameOrId}
                            sx={{ fontSize: '14px' }}
                          >
                        ...
                        {ihLoading && (
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, my: 2 }}>
                            <CircularProgress size={20} />
                            <Typography sx={{ fontSize: '14px', color: '#bbb' }}>Retrieving identity history...</Typography>
                          </Box>
                        )}
                          ...
                          <Box sx={{ mt: 2, p: 2, background: '#232323', borderRadius: 4, overflowY: 'auto', maxHeight: '500px' }}>
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                              ...
                              <Button
                                variant="outlined"
                                size="small"
                                onClick={() => handleCopyToClipboard(JSON.stringify(ihResult, null, 2))}
                                startIcon={<ContentCopyIcon />}
                                sx={{ fontSize: '12px' }}
                              >
                                Copy JSON
                            ...
                            {ihResult && ihResult.history && Array.isArray(ihResult.history) && ihResult.history.length > 0 ? (
                              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                                <Typography sx={{ fontSize: '14px', color: '#90caf9', fontStyle: 'italic' }}>
                                  Found {ihResult.history.length} historical records for this identity
                                </Typography>
                                
                                {ihResult.history.map((historyItem, index) => (
                                  <Accordion 
                                    key={index} 
                                    defaultExpanded={index === 0} 
                                    sx={{ background: '#181818', mb: 1 }}
                                  >
                                    <AccordionSummary 
                                    ...
                                    >
                                      <Box sx={{ display: 'flex', justifyContent: 'space-between', width: '100%', alignItems: 'center' }}>
                                        <Typography sx={{ fontSize: '14px', color: '#90caf9', fontWeight: 700 }}>
                                          {historyItem.identity.name || "Unnamed Identity"} - Block {historyItem.height}
                                        </Typography>
                                        <Typography sx={{ fontSize: '12px', color: '#bbb', mr: 2 }}>
                                          {historyItem.blocktime ? new Date(historyItem.blocktime * 1000).toLocaleString() : ''}
                                        </Typography>
                                      </Box>
                                    </AccordionSummary>
                                    <AccordionDetails>
                                      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                                        <Box sx={{ display: 'flex', gap: 1 }}>
                                          <Typography sx={{ fontSize: '14px', color: '#fff', fontWeight: 600, minWidth: 150 }}>Identity Address:</Typography>
                                          <Typography sx={{ fontSize: '14px', fontFamily: 'monospace', color: '#ddd', flex: 1 }}>
                                            {historyItem.identity.identityaddress || "N/A"}
                                          </Typography>
                                        </Box>
                                        ...
                                        <Box sx={{ display: 'flex', gap: 1 }}>
                                          <Typography sx={{ fontSize: '14px', color: '#fff', fontWeight: 600, minWidth: 150 }}>Transaction ID:</Typography>
                                          <Typography sx={{ fontSize: '14px', fontFamily: 'monospace', color: '#ddd', flex: 1, wordBreak: 'break-all' }}>
                                            {historyItem.output?.txid || "N/A"}
                                          </Typography>
                                        </Box>
                                        
                                        {/* Primary addresses section */}
                                        {historyItem.identity.primaryaddresses && historyItem.identity.primaryaddresses.length > 0 && (
                                          <Box sx={{ display: 'flex', gap: 1 }}>
                                            <Typography sx={{ fontSize: '14px', color: '#fff', fontWeight: 600, minWidth: 150 }}>Primary Addresses:</Typography>
                                            <Box sx={{ flex: 1 }}>
                                              {historyItem.identity.primaryaddresses.map((addr, idx) => (
                                                <Typography key={idx} sx={{ fontSize: '14px', fontFamily: 'monospace', color: '#ddd' }}>
                                                  {addr}
                                                </Typography>
                                              ))}
                                        ...
                                        {historyItem.identity.minimumsignatures !== undefined && (
                                          <Box sx={{ display: 'flex', gap: 1 }}>
                                            <Typography sx={{ fontSize: '14px', color: '#fff', fontWeight: 600, minWidth: 150 }}>Min Signatures:</Typography>
                                            <Typography sx={{ fontSize: '14px', fontFamily: 'monospace', color: '#ddd', flex: 1 }}>
                                              {historyItem.identity.minimumsignatures}
                                            </Typography>
                                          </Box>
                                        )}
                                        
                                        {historyItem.identity.revocationauthority && (
                                          <Box sx={{ display: 'flex', gap: 1 }}>
                                            <Typography sx={{ fontSize: '14px', color: '#fff', fontWeight: 600, minWidth: 150 }}>Revocation Auth:</Typography>
                                            <Typography sx={{ fontSize: '14px', fontFamily: 'monospace', color: '#ddd', flex: 1 }}>
                                              {historyItem.identity.revocationauthority}
                                        ...
                                        {historyItem.identity.recoveryauthority && (
                                          <Box sx={{ display: 'flex', gap: 1 }}>
                                            <Typography sx={{ fontSize: '14px', color: '#fff', fontWeight: 600, minWidth: 150 }}>Recovery Auth:</Typography>
                                            <Typography sx={{ fontSize: '14px', fontFamily: 'monospace', color: '#ddd', flex: 1 }}>
                                              {historyItem.identity.recoveryauthority}
                                        ...
                                        {historyItem.identity.version !== undefined && (
                                          <Box sx={{ display: 'flex', gap: 1 }}>
                                            <Typography sx={{ fontSize: '14px', color: '#fff', fontWeight: 600, minWidth: 150 }}>Version:</Typography>
                                            <Typography sx={{ fontSize: '14px', fontFamily: 'monospace', color: '#ddd', flex: 1 }}>
                                              {historyItem.identity.version}
                                            </Typography>
                                          </Box>
                                        )}
                                        
                                        {historyItem.identity.flags !== undefined && (
                                          <Box sx={{ display: 'flex', gap: 1 }}>
                                            <Typography sx={{ fontSize: '14px', color: '#fff', fontWeight: 600, minWidth: 150 }}>Flags:</Typography>
                                            <Typography sx={{ fontSize: '14px', fontFamily: 'monospace', color: '#ddd', flex: 1 }}>
                                              {historyItem.identity.flags}
                                            </Typography>
                                          </Box>
                                        )}
                                        
                                        {historyItem.identity.timelock !== undefined && (
                                          <Box sx={{ display: 'flex', gap: 1 }}>
                                            <Typography sx={{ fontSize: '14px', color: '#fff', fontWeight: 600, minWidth: 150 }}>Timelock:</Typography>
                                            <Typography sx={{ fontSize: '14px', fontFamily: 'monospace', color: '#ddd', flex: 1 }}>
                                              {historyItem.identity.timelock}
                                            </Typography>
                                          </Box>
                                        )}
                                        
                                        {/* Content Map section - collapsible */}
                                        {historyItem.identity.contentmap && Object.keys(historyItem.identity.contentmap).length > 0 && (
                                          <Accordion defaultExpanded={false} sx={{ background: '#181818', mb: 1, mt: 1 }}>
                                            <AccordionSummary expandIcon={<ExpandMoreIcon sx={{ color: '#fff' }} />}>
                                              <Typography sx={{ fontSize: '14px', color: '#90caf9', fontWeight: 700 }}>
                                                Content Map ({Object.keys(historyItem.identity.contentmap).length} entries)
                                              </Typography>
                                            </AccordionSummary>
                                            <AccordionDetails>
                                              <Box sx={{ maxHeight: '200px', overflowY: 'auto', pr: 1 }}>
                                                {Object.entries(historyItem.identity.contentmap).map(([key, value], idx) => (
                                                  <Box key={idx} sx={{ mb: 1.5, p: 1, background: '#232323', borderRadius: 1 }}>
                                                    <Typography sx={{ color: '#90caf9', fontSize: '13px', fontWeight: 700, fontFamily: 'monospace', mb: 0.5 }}>
                                                      Key: {key}
                                                    </Typography>
                                        ...
                                        {/* Content MultiMap section - collapsible */}
                                        {historyItem.identity.contentmultimap && Object.keys(historyItem.identity.contentmultimap).length > 0 && (
                                          <Accordion defaultExpanded={false} sx={{ background: '#181818', mb: 1 }}>
                                            <AccordionSummary expandIcon={<ExpandMoreIcon sx={{ color: '#fff' }} />}>
                                              <Typography sx={{ fontSize: '14px', color: '#90caf9', fontWeight: 700 }}>
                                                Content MultiMap ({Object.keys(historyItem.identity.contentmultimap).length} entries)
                                              </Typography>
                                            </AccordionSummary>
                                            <AccordionDetails>
                                              <Box sx={{ maxHeight: '200px', overflowY: 'auto', pr: 1 }}>
                                                {Object.entries(historyItem.identity.contentmultimap).map(([primaryKey, entries], idx) => (
                                                  <Box key={idx} sx={{ mb: 1.5, p: 1, background: '#232323', borderRadius: 1 }}>
                                                    <Typography sx={{ color: '#90caf9', fontSize: '13px', fontWeight: 700, fontFamily: 'monospace', mb: 0.5 }}>
                                                      Primary VDXF Key: {primaryKey}
                                                    </Typography>
                              ...
                              <Typography sx={{ fontSize: '14px', color: '#bbb' }}>
                                No history records found for this identity.
                              </Typography>
                            )}
                          </Box>
                        )}
                  ...
                  <Typography sx={{ fontSize: '14px', color: '#bbb' }}>Select an operation from the left panel to begin.</Typography>
                )}
                
                {/* REMOVED: Operation Result display below the form. Results are now only shown in the RPC Terminal. */}
              </Box>
            </Box>
            
            {/* Right Panel - RPC Terminal */}
            <Box sx={{ width: 400, minWidth: 320, background: '#232323', p: 2, ml: 2, display: 'flex', flexDirection: 'column', height: '100%', overflowY: 'hidden' }}>
              <Typography sx={{ fontSize: '16px', color: '#fff', fontWeight: 700, mb: 1 }}>
                RPC Terminal
              </Typography>
              ...
              <Box sx={{ display: 'flex', mb: 1, gap: 1 }}>
                ...
                <Button
                  variant="outlined"
                  size="small"
                  onClick={() => handleSaveTerminalContent()}
                  startIcon={<SaveIcon />}
                  sx={{ fontSize: '12px' }}
                >
                  Save
                ...
                <Select
                  ...
                  size="small"
                  sx={{ fontSize: '12px', ml: 'auto', minWidth: 120 }}
                >
              ...
              <Box sx={{ flex: 1, background: '#181818', borderRadius: 1, p: 1, overflowY: 'auto', fontFamily: 'monospace', fontSize: '12px' }}>
                {!terminalHistory || terminalHistory.length === 0 ? (
                  <Typography sx={{ color: '#bbb', fontSize: '13px', fontStyle: 'italic' }}>No RPC commands executed yet.</Typography>
                ) : (
                  [...terminalHistory].reverse().map((entry, index) => (
                    <Box key={index} sx={{ mb: 2, color: entry?.error ? '#f44336' : '#fff' }}>
                      <Box sx={{ color: '#bbb', mb: 0.5, fontSize: '11px' }}>
                        {entry?.timestamp || new Date().toLocaleString()}
                      </Box>
                      <Box sx={{ color: '#90caf9', mb: 0.5 }}>
                        {entry?.method 
                          ? `> ${formatCliCommand(entry.method, entry.params)}`
                          : entry?.command 
                            ? `> ${entry.command}`
                            : '> [Unknown Command]'
                        }
        ...
        {selectedTab === 1 && (
          <Box sx={{ flex: 1, display: 'flex', flexDirection: 'row', minHeight: 0 }}>
            {/* Main content area: left column (ID list), center (details), right (VDXF Key Management + Verus Command) */}
            {/* Left column */}
            <Box sx={{ width: 220, display: 'flex', flexDirection: 'column', height: '100%' }}>
              {/* Verus ID List */}
              <Box sx={{ flex: 1, overflowY: 'auto', background: '#232323', borderRadius: 0, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
            ...
            {/* Center column: VerusID Details */}
            <Box sx={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', height: '100%' }}>
              <Box sx={{ flex: 1, overflowY: 'auto', background: '#232323', borderRadius: 0, ml: 2, mt: 0, p: 2, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
                <Typography sx={{ fontSize: '14px', color: '#fff', fontWeight: 700, mb: 1 }}>VerusID Details</Typography>
                <Divider sx={{ mb: 1, bgcolor: '#444' }} />
                {loadingDetails && <Typography sx={{ fontSize: '11px', color: '#bbb' }}>Loading identity details...</Typography>}
                {!loadingDetails && identityDetails && !identityDetails.error && (
                  <>
                    <Typography sx={{ fontSize: '14px', color: '#fff', fontWeight: 700, mb: 0.5 }}>{identityDetails.name}</Typography>
                    <Typography sx={{ fontSize: '14px', color: '#bbb', mb: 0.5 }}>ID: {identityDetails.identityaddress}</Typography>
                    <Typography sx={{ fontSize: '14px', color: '#bbb', mb: 0.5 }}>Primary Addresses: {identityDetails.primaryaddresses?.join(', ')}</Typography>
                    <Typography sx={{ fontSize: '14px', color: '#bbb', mb: 0.5 }}>Revocation Authority: {identityDetails.revocationauthority}</Typography>
                    <Typography sx={{ fontSize: '14px', color: '#bbb', mb: 0.5 }}>Recovery Authority: {identityDetails.recoveryauthority}</Typography>
                    <Divider sx={{ my: 0.5, bgcolor: '#444' }} />

                    {/* Transparent Balances section */}
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 0.5 }}>
                      ...
                      <IconButton 
                        size="small" 
                        onClick={() => setTransparentBalanceExpanded(!transparentBalanceExpanded)}
                        sx={{ ml: 'auto', color: '#90caf9' }}
                      >
                        {transparentBalanceExpanded ? <ExpandLessIcon /> : <ExpandMoreIcon />}
                      </IconButton>
                    </Box>
                    <Collapse in={transparentBalanceExpanded} sx={{ mb: 1 }}>
                      <Paper sx={{ p: 1, background: '#181818' }}>
                        {transparentBalance && !transparentBalance.error ? (
                          Object.keys(transparentBalance).length === 0 ? (
                            <span style={{ color: '#bbb', fontSize: '14px' }}>No balances</span>
                          ) : (
                            Object.entries(transparentBalance).map(([currency, amount]) => (
                              <div key={currency} style={{ color: '#90caf9', fontSize: '14px', fontFamily: 'monospace' }}>
                                {currency} : {parseFloat(amount).toLocaleString(undefined, { maximumFractionDigits: 8 })}
                              </div>
                            ))
                          )
                        ) : transparentBalance && transparentBalance.error ? (
                          <span style={{ color: '#f44336', fontSize: '14px' }}>{transparentBalance.error}</span>
                        ) : (
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 0.5 }}>
                      ...
                      <Box sx={{ ml: 1, display: 'flex', gap: 1 }}>
                        <Button
                          variant="outlined"
                          size="small"
                          onClick={handleSaveContentMap}
                          sx={{ fontSize: '12px', minWidth: 0, px: 1, py: 0.5, color: '#90caf9', borderColor: '#90caf9' }}
                        >
                          Save
                        </Button>
                        <Button
                          variant="outlined"
                          size="small"
                          onClick={handleBatchAddContentMap}
                          sx={{ fontSize: '12px', minWidth: 0, px: 1, py: 0.5, color: '#90caf9', borderColor: '#90caf9' }}
                        >
                          Batch Add Entry
                        </Button>
                      ...
                      <IconButton 
                        size="small" 
                        onClick={() => setContentMapExpanded(!contentMapExpanded)}
                        sx={{ ml: 'auto', color: '#90caf9' }}
                      >
                    ...
                    {/* Content Map collapse section */}
                    <Collapse in={contentMapExpanded} sx={{ mb: 1 }}>
                      <Paper sx={{ p: 1, background: '#181818' }}>
                        {/* Content Map Form */}
                        <Box sx={{ mb: 2 }}>
                          <input
                            type="text"
                            placeholder="VDXF Hash160 key from getvdxfid command results (20-byte hex hash of URI string in getvdxfid command. Raw hash value before conversion to base58check format)"
                            value={contentMapKey}
                            onChange={e => setContentMapKey(e.target.value)}
                            style={{ fontSize: '14px', padding: '6px', borderRadius: '4px', border: '1px solid #444', background: '#232323', color: '#fff', width: '100%', marginBottom: '8px' }}
                          />
                          <input
                            type="text"
                            placeholder="Hash value typically from location identifiers or other hash values. The contentmap field in VerusID provides key-value functionality."
                            value={contentMapValue}
                            onChange={e => setContentMapValue(e.target.value)}
                            style={{ fontSize: '14px', padding: '6px', borderRadius: '4px', border: '1px solid #444', background: '#232323', color: '#fff', width: '100%', marginBottom: '8px' }}
                          />
                          <Box sx={{ display: 'flex', gap: 1 }}>
                            <Button
                              variant="contained"
                              color="primary"
                              onClick={handleAddContentMap}
                              sx={{ fontSize: '12px', minWidth: 0, px: 1, py: 0.5 }}
                            >
                              {editingContentMap ? 'Update Entry' : 'Add Entry'}
                            </Button>
                            {editingContentMap && (
                              <Button
                                variant="outlined"
                        ...
                        {/* Content Map List - only this sub-window is scrollable and resizable */}
                        <Box ref={contentMapRef} sx={{ height: contentMapHeight, minHeight: 80, maxHeight: 400, overflowY: 'auto', pr: 1, position: 'relative' }}>
                          {identityDetails.contentmap && Object.keys(identityDetails.contentmap).length > 0 ? (
                            Object.entries(identityDetails.contentmap).map(([vdxfhash, value]) => (
                              <div key={vdxfhash} style={{ marginBottom: '10px', display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                                <Box sx={{ flex: 1 }}>
                                  <span style={{ color: '#90caf9', fontSize: '14px', fontWeight: 700, fontFamily: 'monospace' }}>
                                    VDXF Hash: {vdxfhash}
                                  </span>
                                  <div style={{ color: '#fff', fontSize: '14px', fontFamily: 'monospace', marginLeft: '16px', wordBreak: 'break-all' }}>
                                    Value: {value}
                                  </div>
                                </Box>
                                <Box sx={{ display: 'flex', gap: 1 }}>
                                  <IconButton
                                    size="small"
                                    onClick={() => handleEditContentMap(vdxfhash, value)}
                                    sx={{ color: '#90caf9', '&:hover': { color: '#fff' } }}
                                  >
                                    <EditIcon fontSize="small" />
                                  </IconButton>
                                  <IconButton
                                    size="small"
                                    onClick={() => handleRemoveContentMap(vdxfhash)}
                                    sx={{ color: '#f44336', '&:hover': { color: '#ff6b6b' } }}
                                  >
                            ...
                            <span style={{ color: '#bbb', fontSize: '14px' }}>No content map entries.</span>
                          )}
                          {/* Resizer handle */}
                          <div
                            style={{
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 0.5 }}>
                      ...
                      <IconButton
                        size="small"
                        onClick={() => setContentMultiMapExpanded(!contentMultiMapExpanded)}
                        sx={{ ml: 'auto', color: '#90caf9' }}
                      >
                        {contentMultiMapExpanded ? <ExpandLessIcon /> : <ExpandMoreIcon />}
                      </IconButton>
                    </Box>
                    <Collapse in={contentMultiMapExpanded} sx={{ mb: 1 }}>
                      <Paper sx={{ p: 1, background: '#181818' }}>
                        {/* ContentMultiMap Add/Edit Form */}
                        <Box sx={{ mb: 2 }}>
                          <input
                            type="text"
                            placeholder="Primary VDXF Key (i-address)"
                            value={contentMultiMapPrimaryKey || ''}
                            onChange={e => setContentMultiMapPrimaryKey(e.target.value)}
                            style={{ fontSize: '14px', padding: '6px', borderRadius: '4px', border: '1px solid #444', background: '#232323', color: '#fff', width: '100%', marginBottom: '8px' }}
                          />
                          <input
                            type="text"
                            placeholder="Nested VDXF Key (i-address)"
                            value={contentMultiMapNestedKey || ''}
                            onChange={e => setContentMultiMapNestedKey(e.target.value)}
                            style={{ fontSize: '14px', padding: '6px', borderRadius: '4px', border: '1px solid #444', background: '#232323', color: '#fff', width: '100%', marginBottom: '8px' }}
                          />
                          <textarea
                            placeholder="Structured Data (JSON)"
                            value={contentMultiMapJson || ''}
                            onChange={e => setContentMultiMapJson(e.target.value)}
                            style={{ fontSize: '14px', padding: '6px', borderRadius: '4px', border: '1px solid #444', background: '#232323', color: '#fff', width: '100%', marginBottom: '8px', minHeight: '60px', fontFamily: 'monospace' }}
                          />
                          <Box sx={{ display: 'flex', gap: 1 }}>
                            <Button
                              variant="contained"
                              color="primary"
                              onClick={handleAddOrEditContentMultiMap}
                              sx={{ fontSize: '12px', minWidth: 0, px: 1, py: 0.5 }}
                            >
                              {editingContentMultiMap ? 'Update Entry' : 'Add Entry'}
                            </Button>
                            {editingContentMultiMap && (
                              <Button
                                variant="outlined"
                                color="primary"
                                onClick={handleCancelEditContentMultiMap}
                                sx={{ fontSize: '12px', minWidth: 0, px: 1, py: 0.5 }}
                              >
                                Cancel
                              </Button>
                          ...
                          {contentMultiMapError && (
                            <Typography sx={{ color: '#f44336', fontSize: '13px', mt: 1 }}>{contentMultiMapError}</Typography>
                          )}
                        </Box>
                        {/* ContentMultiMap List - scrollable */}
                        <Box ref={contentMultiMapRef} sx={{ height: contentMultiMapHeight, minHeight: 80, maxHeight: 400, overflowY: 'auto', pr: 1, position: 'relative' }}>
                          {identityDetails.contentmultimap && Object.keys(identityDetails.contentmultimap).length > 0 ? (
                            Object.entries(identityDetails.contentmultimap).map(([primaryKey, entries], idx) => (
                              <Box key={idx} sx={{ mb: 0.5, p: 1, background: '#232323', borderRadius: 1 }}>
                                <Typography sx={{ color: '#90caf9', fontSize: '13px', fontWeight: 700, fontFamily: 'monospace', mb: 0.5 }}>
                            ...
                            <span style={{ color: '#bbb', fontSize: '14px' }}>No content multimap entries.</span>
                          )}
                          {/* Resizer handle */}
                          <div
                            style={{
                            ...
                            onMouseDown={handleMouseDownMultiMap}
                          />
                        </Box>
                      </Paper>
                    </Collapse>
            ...
            {/* Vertical Divider */}
            <Divider orientation="vertical" flexItem sx={{ bgcolor: '#444', mx: 2 }} />

            {/* VDXF Key Management (center-right) */}
            <Box sx={{ width: 400, minWidth: 320, background: '#232323', p: 2, display: 'flex', flexDirection: 'column', height: '100%' }}>
              <Typography sx={{ fontSize: '16px', color: '#fff', fontWeight: 700, mb: 2 }}>
                VDXF Key Management
              </Typography>
              {/* VDXF Key creation form */}
              <Paper sx={{ p: 2, mb: 2, background: '#181818' }}>
                <Typography sx={{ fontSize: '14px', color: '#fff', fontWeight: 600, mb: 1 }}>Create VDXF Key</Typography>
                <Box component="form" onSubmit={handleCreateVdxfKey} sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  <input
                    type="text"
                    placeholder="VDXF URI (e.g. system.currency.export)"
                    value={vdxfUri}
                    onChange={e => setVdxfUri(e.target.value)}
                    style={{ fontSize: '14px', padding: '6px', borderRadius: '4px', border: '1px solid #444', background: '#232323', color: '#fff' }}
                  />
                  <input
                    type="text"
                    placeholder="Optional: Parent VDXF Key (i-address)"
                    value={parentVdxfKey}
                  ...
                  <input
                    type="text"
                    placeholder="Optional: uint256 (32-byte hex)"
                    value={uint256}
                  ...
                  <input
                    type="number"
                    placeholder="Optional: Index Number (integer)"
                    value={indexNum}
                    onChange={e => setIndexNum(e.target.value)}
                    style={{ fontSize: '14px', padding: '6px', borderRadius: '4px', border: '1px solid #444', background: '#232323', color: '#fff' }}
                  />
                  <Button type="submit" variant="contained" color="primary" sx={{ mt: 1, fontSize: '14px', fontWeight: 700 }}>
                    Create VDXF Key
                  </Button>
                </Box>
              </Paper>
              {vdxfError && (
                <Typography sx={{ color: '#f44336', fontSize: '13px', mt: 1 }}>{vdxfError}</Typography>
              )}
              <Paper sx={{ mt: 2, p: 2, background: '#181818', height: '60vh', display: 'flex', flexDirection: 'column' }}>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                  <Typography sx={{ fontSize: '14px', color: '#fff', fontWeight: 600 }}>Created VDXF Keys</Typography>
                  <Box sx={{ ml: 'auto', display: 'flex', gap: 1 }}>
                    <Button
                      variant="outlined"
                      size="small"
                      onClick={handleSaveVdxfKeys}
                      sx={{ fontSize: '12px', minWidth: 0, px: 1, py: 0.5, color: '#90caf9', borderColor: '#90caf9' }}
                    >
                      Save
                    </Button>
                ...
                <Box sx={{ flex: 1, overflowY: 'auto', background: '#232323', borderRadius: 1 }}>
                  <List dense>
                      ...
                      >
                        <Box sx={{ width: '100%' }}>
                          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 0.5 }}>
                            <Typography sx={{ fontSize: '13px', color: '#90caf9', fontFamily: 'monospace' }}>
                              {key.uri}
                            </Typography>
                            <IconButton
                              size="small"
                              onClick={() => handleDeleteVdxfKey(index)}
                              sx={{ color: '#f44336', '&:hover': { color: '#ff6b6b' }, padding: '2px' }}
                            >
                              <DeleteIcon sx={{ fontSize: '16px' }} />
                            </IconButton>
                          </Box>
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mb: 0.25 }}>
                            <Typography sx={{ fontSize: '12px', color: '#bbb', fontFamily: 'monospace', wordBreak: 'break-all', flex: 1 }}>
                              VDXFID: {key.result.vdxfid}
                            </Typography>
                            <IconButton
                              size="small"
                              onClick={() => handleCopyToClipboard(key.result.vdxfid)}
                              sx={{ color: '#90caf9', '&:hover': { color: '#fff' }, padding: '2px' }}
                            >
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mb: 0.25 }}>
                            <Typography sx={{ fontSize: '12px', color: '#bbb', fontFamily: 'monospace', wordBreak: 'break-all', flex: 1 }}>
                              hash160: {key.result.hash160result}
                            </Typography>
                            <IconButton
                              size="small"
                              onClick={() => handleCopyToClipboard(key.result.hash160result)}
                              sx={{ color: '#90caf9', '&:hover': { color: '#fff' }, padding: '2px' }}
                            >
                              <ContentCopyIcon sx={{ fontSize: '16px' }} />
                            </IconButton>
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mb: 0.25 }}>
                            <Typography sx={{ fontSize: '12px', color: '#bbb', fontFamily: 'monospace', wordBreak: 'break-all', flex: 1 }}>
                              Parent: {key.result.qualifiedname?.namespace || key.uri.split('.').slice(0, -1).join('.') || 'None'}
                            </Typography>
                            {(key.result.qualifiedname?.namespace || key.uri.split('.').slice(0, -1).join('.')) && (
                              <IconButton
                                size="small"
                                onClick={() => handleCopyToClipboard(key.result.qualifiedname?.namespace || key.uri.split('.').slice(0, -1).join('.'))}
                                sx={{ color: '#90caf9', '&:hover': { color: '#fff' }, padding: '2px' }}
                              >
                                <ContentCopyIcon sx={{ fontSize: '16px' }} />
                              </IconButton>
                          ...
                          {/* Display optional fields if they were used */}
                          {key.extraparams && Object.keys(key.extraparams).length > 0 && (
                            <Box sx={{ mt: 0.5, pl: 1, borderLeft: '2px solid #444' }}>
                              <Typography sx={{ fontSize: '12px', color: '#90caf9', fontFamily: 'monospace', mb: 0.5 }}>
                                Creation Parameters:
                              </Typography>
                              {key.extraparams.vdxfkey && (
                                <Typography sx={{ fontSize: '12px', color: '#bbb', fontFamily: 'monospace', ml: 1 }}>
                                  Parent VDXF Key: {key.extraparams.vdxfkey}
                                </Typography>
                              )}
                              {key.extraparams.uint256 && (
                                <Typography sx={{ fontSize: '12px', color: '#bbb', fontFamily: 'monospace', ml: 1 }}>
                                  uint256: {key.extraparams.uint256}
                                </Typography>
                              )}
                              {key.extraparams.indexnum !== undefined && (
                                <Typography sx={{ fontSize: '12px', color: '#bbb', fontFamily: 'monospace', ml: 1 }}>
                                  Index Number: {key.extraparams.indexnum}
                                </Typography>
                              )}
                            </Box>
                          )}
            ...
            {/* Unified Verus Command window (rightmost column) */}
            <Divider orientation="vertical" flexItem sx={{ bgcolor: '#444', mx: 2 }} />
            <Box sx={{ width: 350, minWidth: 240, background: '#232323', p: 2, display: 'flex', flexDirection: 'column', height: '100%' }}>
              <Box sx={{ height: '50%', mt: 2, p: 2, background: '#181818', borderRadius: 1, fontSize: '13px', color: '#90caf9', fontFamily: 'monospace', wordBreak: 'break-all', overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
                <Typography sx={{ fontSize: '13px', color: '#90caf9', mb: 0.5 }}>
                  <b>Verus Command History:</b>
                </Typography>
                {!terminalHistory || terminalHistory.length === 0 ? (
                  <Typography sx={{ fontSize: '12px', color: '#666', fontStyle: 'italic' }}>
                  ...
                  [...terminalHistory].reverse().map((entry, idx) => (
                    <Box key={idx} sx={{ mb: 3 }}>
                      <Box sx={{ color: '#bbb', mb: 0.5, fontSize: '11px' }}>
                        {entry?.timestamp || new Date().toLocaleString()}
                      </Box>
        ...
        {selectedTab === 2 && (
          <Box sx={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#bbb', fontSize: '18px' }}>
